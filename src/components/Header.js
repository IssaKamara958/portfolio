...
const Header = () => {
      ...
      <div className="header-content">
        <div className="text-section">
          ...
          <div className="buttons">
            {/* <button className="work-btn">Voir Mes Travaux</button> */}
  ...
  <a href="https://wa.me/221776828441" target="_blank" rel="noopener noreferrer" className="contact-btn" >WhatsApp</a>
        ...
        <div className="image-section">
          {/* <img src=".../public/assets/issa.jpg" alt="Issa Kamara - Développeur Web" /> */}
          <img src={`${process.env.PUBLIC_URL}/assets/issa.jpg`} alt="Issa Kamara - Développeur Web" />
